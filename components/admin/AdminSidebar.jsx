...
const menuItems = [
  ...
  { name: 'Loans', href: '/admin/loan', icon: Wallet },
  // { name: 'Assin Job', href: '/admin/job-assignment', icon: FileText },
  { name: 'Food', href: '/admin/foods', icon: FileText },
  { name: 'Menu', href: '/admin/food-approve', icon: FileText },
  ...
  { name: 'QR code', href: '/admin/qrcode', icon: Calendar },
