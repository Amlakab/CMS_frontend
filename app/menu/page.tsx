...
import Footer from '@/components/ui/Footer'; // Add if you have a footer
import {
...
const PublicFoodPage = () => {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      {/* Food Detail Dialog - Fixed Image Display */}
      <Dialog 
        open={openViewDialog} 
        ...
        {selectedFood && (
          <>
            ...
            <DialogContent sx={{ p: 0, overflowY: 'auto' }}>
              {/* Food Image - FIXED: Using corrected image handling */}
              {selectedFood.image && (
                <Box sx={{ 
                  width: '100%',
                  ...
                  <img
                    src={getImageUrl(selectedFood) || getPlaceholderImage(selectedFood.name, theme === 'dark' ? '#00ffff' : '#007bff')}
